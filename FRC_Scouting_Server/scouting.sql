...
CREATE TABLE IF NOT EXISTS `fact_match_data_2023` (
  ...
  `auto_left_grid_top_left` tinyint(1) NOT NULL DEFAULT '0',
  `auto_left_grid_top_mid` tinyint(1) NOT NULL DEFAULT '0',
  `auto_left_grid_top_right` tinyint(1) NOT NULL DEFAULT '0',
  `auto_left_grid_mid_left` tinyint(1) NOT NULL DEFAULT '0',
  `auto_left_grid_mid_mid` tinyint(1) NOT NULL DEFAULT '0',
  `auto_left_grid_mid_right` tinyint(1) NOT NULL DEFAULT '0',
  `auto_left_grid_hyb_left` tinyint(1) NOT NULL DEFAULT '0',
  `auto_left_grid_hyb_mid` tinyint(1) NOT NULL DEFAULT '0',
  `auto_left_grid_hyb_right` tinyint(1) NOT NULL DEFAULT '0',
  `auto_coop_grid_top_left` tinyint(1) NOT NULL DEFAULT '0',
  `auto_coop_grid_top_mid` tinyint(1) NOT NULL DEFAULT '0',
  `auto_coop_grid_top_right` tinyint(1) NOT NULL DEFAULT '0',
  `auto_coop_grid_mid_left` tinyint(1) NOT NULL DEFAULT '0',
  `auto_coop_grid_mid_mid` tinyint(1) NOT NULL DEFAULT '0',
  `auto_coop_grid_mid_right` tinyint(1) NOT NULL DEFAULT '0',
  `auto_coop_grid_hyb_left` tinyint(1) NOT NULL DEFAULT '0',
  `auto_coop_grid_hyb_mid` tinyint(1) NOT NULL DEFAULT '0',
  `auto_coop_grid_hyb_right` tinyint(1) NOT NULL DEFAULT '0',
  `auto_right_grid_top_left` tinyint(1) NOT NULL DEFAULT '0',
  `auto_right_grid_top_mid` tinyint(1) NOT NULL DEFAULT '0',
  `auto_right_grid_top_right` tinyint(1) NOT NULL DEFAULT '0',
  `auto_right_grid_mid_left` tinyint(1) NOT NULL DEFAULT '0',
  `auto_right_grid_mid_mid` tinyint(1) NOT NULL DEFAULT '0',
  `auto_right_grid_mid_right` tinyint(1) NOT NULL DEFAULT '0',
  `auto_right_grid_hyb_left` tinyint(1) NOT NULL DEFAULT '0',
  `auto_right_grid_hyb_mid` tinyint(1) NOT NULL DEFAULT '0',
  `auto_right_grid_hyb_right` tinyint(1) NOT NULL DEFAULT '0',
  `auto_charge_station` int(2) UNSIGNED NOT NULL,
  `left_grid_top_left` tinyint(1) NOT NULL DEFAULT '0',
  `left_grid_top_mid` tinyint(1) NOT NULL DEFAULT '0',
  `left_grid_top_right` tinyint(1) NOT NULL DEFAULT '0',
  `left_grid_mid_left` tinyint(1) NOT NULL DEFAULT '0',
  `left_grid_mid_mid` tinyint(1) NOT NULL DEFAULT '0',
  `left_grid_mid_right` tinyint(1) NOT NULL DEFAULT '0',
  `left_grid_hyb_left` tinyint(1) NOT NULL DEFAULT '0',
  `left_grid_hyb_mid` tinyint(1) NOT NULL DEFAULT '0',
  `left_grid_hyb_right` tinyint(1) NOT NULL DEFAULT '0',
  `coop_grid_top_left` tinyint(1) NOT NULL DEFAULT '0',
  `coop_grid_top_mid` tinyint(1) NOT NULL DEFAULT '0',
  `coop_grid_top_right` tinyint(1) NOT NULL DEFAULT '0',
  `coop_grid_mid_left` tinyint(1) NOT NULL DEFAULT '0',
  `coop_grid_mid_mid` tinyint(1) NOT NULL DEFAULT '0',
  `coop_grid_mid_right` tinyint(1) NOT NULL DEFAULT '0',
  `coop_grid_hyb_left` tinyint(1) NOT NULL DEFAULT '0',
  `coop_grid_hyb_mid` tinyint(1) NOT NULL DEFAULT '0',
  `coop_grid_hyb_right` tinyint(1) NOT NULL DEFAULT '0',
  `right_grid_top_left` tinyint(1) NOT NULL DEFAULT '0',
  `right_grid_top_mid` tinyint(1) NOT NULL DEFAULT '0',
  `right_grid_top_right` tinyint(1) NOT NULL DEFAULT '0',
  `right_grid_mid_left` tinyint(1) NOT NULL DEFAULT '0',
  `right_grid_mid_mid` tinyint(1) NOT NULL DEFAULT '0',
  `right_grid_mid_right` tinyint(1) NOT NULL DEFAULT '0',
  `right_grid_hyb_left` tinyint(1) NOT NULL DEFAULT '0',
  `right_grid_hyb_mid` tinyint(1) NOT NULL DEFAULT '0',
  `right_grid_hyb_right` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `game_info` (`keystring`, `intvalue`, `stringval`, `invalid`) VALUES
('2023_charge_none', 0, 'No Charge Station', 0),
('2023_charge_dock', 1, 'Docked Charge Station', 0),
('2023_charge_engage', 2, 'Engaged Charge Station', 0);
