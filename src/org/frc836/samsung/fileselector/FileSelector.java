...
public class FileSelector {
	 ...
	 *            The current context.
	 * @param operation
	 *            LOAD - to load file / SAVE - to save file / SELECTDIR - to
	 *            select a directory
