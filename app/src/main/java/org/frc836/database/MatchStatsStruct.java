...
public class MatchStatsStruct {
	...
	public boolean hab_climb_2_left_attempted;
	...
	public static final String COLUMN_NAME_HAB_CLIMB_2_LEFT_ATTEMPTED = FACT_MATCH_DATA_2019_Entry.COLUMN_NAME_HAB_CLIMB_2_LEFT_ATTEMPTED;
	...
	public void init() {
		...
		hab_climb_2_left_attempted = false;
	...
	public ContentValues getValues(DB db, SQLiteDatabase database) {
		...
		vals.put(COLUMN_NAME_HAB_CLIMB_2_LEFT_ATTEMPTED, hab_climb_2_left_attempted ? 1 : 0);
	...
	public void fromCursor(Cursor c, DB db, SQLiteDatabase database, int pos) {
		...
		hab_climb_2_left_attempted = c.getInt(c.getColumnIndexOrThrow(COLUMN_NAME_HAB_CLIMB_2_LEFT_ATTEMPTED)) != 0;
	...
	public String[] getProjection() {
		List<String> temp = new ArrayList<String>(41);
		...
		temp.add(COLUMN_NAME_HAB_CLIMB_2_LEFT_ATTEMPTED);
	...
	public ContentValues jsonToCV(JSONObject json) throws JSONException {
		...
		vals.put(COLUMN_NAME_HAB_CLIMB_2_LEFT_ATTEMPTED, json.has(COLUMN_NAME_HAB_CLIMB_2_LEFT_ATTEMPTED) ? json.getInt(COLUMN_NAME_HAB_CLIMB_2_LEFT_ATTEMPTED) : 0);
	...
	public LinkedHashMap<String,String> getDisplayData() {
		...
		vals.put( COLUMN_NAME_HAB_CLIMB_2_LEFT_ATTEMPTED, String.valueOf(hab_climb_2_left_attempted ? 1 : 0));
